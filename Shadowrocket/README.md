...
## ⚠️ 特别说明 ⚠️
1. 一定要是 Shadowrocket 的 2.1.49 (964) 及以上 TF 或商店版本，因为旧版本中有一个正则出错导致匹配结果越界的 Bug，会使得 VPN 停止运行。
...
### 方法一：直接订阅简易跨服配置
1. 在首页，点击右上角"+"，添加一个类型为"HTTPS"、地址为"127.0.0.1"、端口为"1080"的节点，然后在首页的"服务器节点"中选中该节点；
2. 将"全局路由"改为"直连"；
