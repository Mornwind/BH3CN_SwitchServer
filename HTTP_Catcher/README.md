...
## 配置方法
1. **下载并导入跨服配置文件**：找到并下载“.hcc”类型的跨服配置文件，通过“共享”或“在其他应用中打开”调出系统分享菜单，然后选择“拷贝到‘HTTP Catcher’”；在 HTTP Catcher 中弹出的“导入”对话框中选择“好的”。
...
8. **启动 HTTP Catcher**：点击“历史”页面右上角的“启动”，即可完成跨服。（不玩游戏时，别忘了停止 HTTP Catcher。）
